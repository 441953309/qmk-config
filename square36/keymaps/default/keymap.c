...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_3(
        ...
        //|------------+--------------+--------------+--------------+--------------|            |----------+--------------+--------------+--------------+--------------|
                                       LCTL_T(KC_ESC),  LT(2,KC_SPC),       XXXXXXX,                XXXXXXX,        KC_ENT,       KC_BSPC
                                    //`--------------------------------------------'            `----------------------------------------'
        ),
    ...
    [1] = LAYOUT_split_3x5_3(
        ...
        //|--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------|
                              KC_BSPC,  KC_ENT, XXXXXXX,          XXXXXXX,  KC_ENT,  KC_DEL
                          //`--------------------------'        `--------------------------'
        ),
    ...
    [2] = LAYOUT_split_3x5_3(
        ...
        //|--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------|
                              XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX,LT(3,KC_GRV), KC_BSLS
                          //`--------------------------'        `--------------------------'
      ),
