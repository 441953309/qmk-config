...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        //|--------+------------+--------------+--------------+--------------+--------------|                        |--------------+--------------+--------------+--------------+--------+--------|
            XXXXXXX,     XXXXXXX,       KC_LGUI,       KC_LALT,       KC_LSFT,       _______,                                KC_LEFT,       KC_DOWN,         KC_UP,      KC_RIGHT, _______, XXXXXXX,
        //|--------+------------+--------------+--------------+--------------+--------------|                        |--------------+--------------+--------------+--------------+--------+--------|
    ...
    [2] = LAYOUT(
      ...
      //|--------+--------------+--------------+--------------+--------------+--------------|                        |--------------+--------------+--------------+--------------+--------+--------|
          XXXXXXX,          KC_1,          KC_2,          KC_3,          KC_4,          KC_5,                                KC_UNDS,       KC_PLUS,       KC_LBRC,       KC_LCBR, KC_LPRN,  KC_F12,
      //|--------+--------------+--------------+--------------+--------------+--------------|                        |--------------+--------------+--------------+--------------+--------+--------|
          XXXXXXX,          KC_6,          KC_7,          KC_8,          KC_9,          KC_0,                                KC_MINS,       KC_BSLS,       KC_RBRC,       KC_RCBR, KC_RPRN, XXXXXXX,
      //|--------+--------------+--------------+--------------+--------------+--------------|                        |--------------+--------------+--------------+--------------+--------+--------|
          XXXXXXX,LSFT_T(KC_DOT),       KC_QUOT,       KC_DQUO,        KC_GRV,       KC_TILD,   XXXXXXX,      XXXXXXX,       KC_SLSH,       KC_ASTR,       KC_COLN,       KC_SCLN, KC_BSLS, XXXXXXX,
      //|--------+--------------+--------------+--------------+--------------+--------------+----------|  |----------+--------------+--------------+--------------+--------------+--------+--------|
                                        XXXXXXX,       XXXXXXX,       KC_LCTL,       XXXXXXX,    KC_SPC,       KC_ENT,       XXXXXXX,       KC_RCTL,       XXXXXXX,       XXXXXXX
                              //`----------------------------------------------------------------------'  `----------------------------------------------------------------------'
      ),
    ...
    [3] = LAYOUT(
        ...
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, KC_MPRV, KC_VOLD, KC_MUTE, KC_VOLU, KC_MNXT, KC_MPLY,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
